...
<?
	...
	<script type="text/javascript">
	  ...
	  <body onload="getLocation()">
		...
		<div id="main">
			<?showDetails($_GET['id']);?><br/>
			<hr/>
			Σχόλια:
			<br/>
			<?showComments($_GET['id']);?><br/>
			<br/>
			Προσθήκη σχολίου<br/>
			<form action="logic.php" method="post">
				<strong>Σχόλιο:<br/></strong>
				<textarea name="comment"></textarea><br/>
				<input type="hidden" name="photo" value="<?echo $_GET['id'];?>"/>
				<input type="hidden" name="user" value="<?echo $_SESSION['username'];?>"/>
				<input type="submit" name="newComment" value="προσθήκη σχολίου"/>
			</form>
		</div>
